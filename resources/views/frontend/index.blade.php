                   ...
                   <div class="container " >
                       <div class="rounded" style="background-color: transparent;">
                            ...
                            <!--<div class="d-flex mb-2 align-items-baseline title-line">-->
                                ...
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="pb-3 d-inline-block fs-sm-16-title">{{ $locale == 'en' ? 'Advertisement' : 'এডভারটাইসমেন্ট' }} </span>
                                    <!--{{ translate('Classified Ads') }}-->
  ...
  <!--  </div>  -->
     ...
     <div  class="mb-4 mt-4">
                ...
                <div class="container " >
                     <div class="d-flex mb-3 align-items-baseline">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-width-2 d-inline-block fs-sm-16-title">  {{ $locale == 'en' ? 'Corporate Ad' : ' কর্পোরেট বিজ্ঞাপন '}} </span>
                                    <!--{{ translate('Classified Ads') }}-->
                                </h3>
                            </div>
    ...
    <div id="section_home_categories">
     ...
     <div  class="mb-4 mt-4">
                <div class="container ">
                    <div class="d-flex mb-3 align-items-baseline">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-width-2 d-inline-block fs-sm-16-title"> {{ $locale == 'en' ? 'Ad Store' : ' বিজ্ঞাপনের দোকান  ' }}  </span>
                                    <!--{{ translate('Classified Ads') }}-->
                                </h3>
                            </div>
                    <div class="row">
        ...
        @endphp
                   <div class="container " >
                       <div class="rounded">
                            <div class="d-flex mb-3 align-items-baseline">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-width-2 d-inline-block fs-sm-16-title" style="border-color: #572c84 !important;">  {{ $locale == 'en' ? ' Our Partners' : ' আমাদের অংশীদারদের ' }}  </span>
