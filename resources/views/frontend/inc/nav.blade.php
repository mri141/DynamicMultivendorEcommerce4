         ...
         @if($locale == 'en')
                <ul class="list-inline mb-0 mobile-hor-swipe text-right">
                    ...
                    <li class="list-inline-item mr-0">
                     ...
                     <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded get-app-btn">SKB World</button>
                        </a>
          ...
          <ul class="list-inline mb-0 mobile-hor-swipe text-right">
                     ...
                     <li class="list-inline-item mr-0">
                        <a style="font-family: 'Roboto', sans-serif;"
                            href="{{ route('shops.create') }}"
                            class="fs-md-15 fs-16 fs-sm-13 fs-xs-12 px-3 pl-md-3 py-2 d-inline-block hov-opacity-100 text-reset fw-600">
                            <span class="menu-text-hover"> বিক্রেতা </span>
                        </a>
                    </li>
                    <li class="list-inline-item mr-0">
                        <a style="font-family: 'Roboto', sans-serif;"
                            href="{{ route('user.registration') }}"
                            class="fs-md-15 fs-sm-13 fs-xs-12 fs-16 px-3 py-2 d-inline-block hov-opacity-100 text-reset fw-600">
                            <span class="menu-text-hover"> ক্রেতা </span>
                        </a>
                    </li>
                      ...
                      <li class="list-inline-item mr-0">
                        <a style="font-family: 'Roboto', sans-serif;"
                            href="{{ route('orders.track') }}"
                            class="fs-md-15 fs-sm-13 fs-xs-12 fs-16 px-3 py-2 d-inline-block hov-opacity-100 text-reset fw-600">
                            <span class="menu-text-hover"> অর্ডার ট্র্যাক </span>
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="{{ route('customer.care') }}" style="font-family: 'Roboto', sans-serif;"
                            class="fs-md-15 fs-sm-13 fs-xs-12 fs-16 px-3 py-2 d-inline-block hov-opacity-100 text-reset fw-600">
                            <span class="menu-text-hover"> কাস্টমার কেয়ার  </span>
                    ...
                    <!--</li>-->
                     ...
                     <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded live-btn">লাইভ </button>
                        </a>
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded get-app-btn"> এন্টারটেইনমেন্ট </button>
                        </a>
                     ...
                     <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded get-app-btn"> এসকেবি ওয়ার্ল্ড</button>
                        </a>
                     ...
                     <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded get-app-btn"> এপস  </button>
                        </a>
                    ...
                    @if (!Auth::check())
                        <li class="list-inline-item mr-0">
                            ...
                            <a class="fs-18 py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset" href="{{ route('user.login') }}">
                                <button type="button" class="btn btn-rounded get-app-btn"> লগইন </button>
                            </a>
